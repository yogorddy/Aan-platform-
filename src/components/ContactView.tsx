...
export default function ContactView({ onNavigate }: ContactViewProps) {
  ...
  return (
    <div className="min-h-screen bg-[#050507] text-[#8c919d] font-sans selection:bg-emerald-500/10 selection:text-white flex flex-col justify-between relative overflow-hidden">
      ...
      {/* Header */}
      <header className="border-b border-white/[0.03] bg-[#050507]/80 backdrop-blur sticky top-0 z-40 px-6 md:px-12 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            <div className="w-7 h-7 rounded-full bg-white/[0.02] border border-white/[0.06] flex items-center justify-center transition-all group-hover:border-white/[0.12]">
              <Shield className="w-3.5 h-3.5 text-emerald-400" />
            </div>
            <div className="flex flex-col">
              <span className="font-sans font-semibold text-white tracking-widest text-xs leading-none">AAN</span>
              <span className="text-[7px] font-mono tracking-widest text-[#646e7a] mt-0.5 uppercase">Authentic Network Node</span>
            </div>
          </button>

          <button 
            onClick={() => onNavigate('landing')}
            className="inline-flex items-center gap-1.5 text-[10px] font-mono text-slate-500 hover:text-slate-300 transition-colors bg-transparent border-none cursor-pointer"
          >
      ...
      <main className="flex-1 flex flex-col items-center justify-center max-w-2xl mx-auto w-full relative z-10 px-6 py-12 my-auto">
        ...
        <div className="w-full space-y-8">
          ...
          <div className="text-center space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/[0.03] border border-emerald-500/[0.1] text-[9px] font-mono tracking-widest text-emerald-400 uppercase">
              <Mail className="w-3 h-3 text-emerald-400" />
              <span>Contact Desk</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-sans font-light text-white tracking-tight leading-tight">
          ...
          {/* Contact Card */}
          <div className="bg-[#0b0c10] border border-white/[0.04] rounded-2xl p-6 md:p-8 relative overflow-hidden">
              ...
              {contactSubmitted ? (
                ...
                >
                  ...
                  <div className="space-y-4">
                    <h3 id="success-title" className="text-xl font-light text-white tracking-tight">Request Received</h3>
                    
                    <p id="success-body" className="text-xs text-slate-400 max-w-md mx-auto leading-relaxed pt-2">
                    ...
                    <div id="technical-line" className="text-[10px] font-mono text-emerald-400 bg-emerald-500/[0.03] border border-emerald-500/[0.1] rounded-lg py-1.5 px-3 max-w-xs mx-auto">
                      STATUS: INTEGRATION_REQUEST_RECORDED
                    </div>

                    <div id="success-reference" className="bg-[#12131a] border border-white/[0.06] rounded-xl py-3 px-4 max-w-xs mx-auto">
                      <span className="text-[10px] font-mono uppercase text-slate-500 tracking-wider block mb-1">Request Code</span>
                      <span className="font-mono text-white text-sm font-semibold tracking-wider block">{generatedCode}</span>
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-[10px] font-mono text-emerald-400 hover:text-emerald-300 transition-colors bg-transparent border-none cursor-pointer"
                    >
                ...
                >
                  {errorMsg && (
                    <div className="bg-red-500/[0.04] border border-red-500/[0.15] rounded-xl p-3.5 flex items-start gap-2.5 text-xs text-red-400">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input 
                        ...
                        className={`w-full bg-[#07080a] border focus:outline-none rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-600 transition-colors ${
                          validationErrors.organization_name ? 'border-red-500/50 focus:border-red-500' : 'border-white/[0.06] focus:border-white/[0.15]'
                        }`}
                      />
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input 
                        ...
                        className={`w-full bg-[#07080a] border focus:outline-none rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-600 transition-colors ${
                          validationErrors.contact_name ? 'border-red-500/50 focus:border-red-500' : 'border-white/[0.06] focus:border-white/[0.15]'
                        }`}
                      />
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input 
                        ...
                        className={`w-full bg-[#07080a] border focus:outline-none rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-600 transition-colors ${
                          validationErrors.email ? 'border-red-500/50 focus:border-red-500' : 'border-white/[0.06] focus:border-white/[0.15]'
                        }`}
                      />
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select 
                        ...
                        className="w-full bg-[#07080a] border border-white/[0.06] focus:border-white/[0.15] focus:outline-none rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-600 transition-colors appearance-none"
                      >
                        ...
                        <button
                          ...
                          className={`py-2 px-3 rounded-xl border text-center text-xs capitalize transition-all cursor-pointer font-medium ${
                            form.urgency === lvl
                              ...
                              : 'bg-[#07080a] text-slate-400 border-white/[0.04] hover:text-white hover:border-white/[0.1]'
                          }`}
                        >
                          {lvl}
                        </button>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea 
                      ...
                      rows={4}
                      className={`w-full bg-[#07080a] border focus:outline-none rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-slate-600 transition-colors resize-none ${
                        validationErrors.message ? 'border-red-500/50 focus:border-red-500' : 'border-white/[0.06] focus:border-white/[0.15]'
                      }`}
                    />
                  ...
                  <button 
                    type="submit"
                    disabled={loading}
                    className="w-full bg-white hover:bg-slate-100 disabled:bg-slate-800 disabled:text-slate-500 text-slate-950 text-xs font-semibold py-3 px-4 rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2 active:scale-[0.99]"
                  >
                    {loading ? (
                      <>
          ...
          <div className="bg-[#0b0c10]/40 border border-white/[0.03] rounded-2xl p-4 flex items-center justify-between">
            <div className="flex items-center gap-2.5 text-left">
              <div className="w-8 h-8 rounded-lg bg-slate-900 border border-white/[0.06] flex items-center justify-center text-white font-bold text-xs">
                A
              </div>
              <div>
                <div className="text-xs font-semibold text-white tracking-tight">AAN Global Grid</div>
            ...
            <div className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-500/[0.03] border border-emerald-500/[0.1] text-[8px] font-mono font-medium text-emerald-400">
      ...
      <footer className="max-w-7xl mx-auto w-full py-12 px-6 md:px-12 flex flex-col sm:flex-row items-center justify-between text-[10px] font-mono text-[#525a66] gap-4 z-10">
        ...
        <div className="flex gap-6">
          <button onClick={() => onNavigate('privacy', '/privacy')} className="hover:text-[#646e7a] cursor-pointer bg-transparent border-none">Privacy Charter</button>
          <button onClick={() => onNavigate('terms', '/terms')} className="hover:text-[#646e7a] cursor-pointer bg-transparent border-none">Terms of Service</button>
          <button onClick={() => onNavigate('trustdocs')} className="hover:text-[#646e7a] cursor-pointer bg-transparent border-none">Resource Hub</button>
        </div>
      </footer>
